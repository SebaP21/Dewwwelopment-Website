		...
		>
			...
			<div className='flex gap-2 '>
				<button
					...
					className='bg-transparent border transition-all border-light px-4 text-sm py-2 hover:bg-white hover:text-black'
				>
					Akceptuję
				</button>
				<button
					onClick={handleDecline}
					className='bg-transparent border transition-all text-sm border-light px-3 p-1  hover:bg-white hover:text-black'
				>
					Odrzucam
				</button>
				<button className='bg-transparent text-sm border transition-all border-light px-3 p-1  hover:bg-white hover:text-black'>
